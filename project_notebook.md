...
1. options include 1. (maximum) size of each text 1. texts: path to json file 1. number of words 1. seet 1. val and test split 1. preview: shows the number of preview files specified 1. curicullum: determines if its saved as opposed to run dynamically during training
...
1. 1/20/26 sample_log not saving. 
...
1. temperature is by default at 0.6. we probably need to set higher, but at least set explicitly.

1. 1/20/26 currently training on % alignment and not on raw scores. claude (incorrectly) changed that tonight. I’m pretty sure the first (10 word) training was done on scores, but it would have been with linear gap penalty instead of affine. I think we’re going to have to redo both. I should treat the current run, not as data collection, but as exploration in advance of data collection.

1. 1/21/26 old linear NW had -0.5 per gap, current has (something like) -5 for open and -1 for continuation. so our affine has higher penalty than our linear did
...
1. JFK Inaugural - "Ask not what your country can do"

1. FDR Pearl Harbor address (full)

1. Patrick Henry "Give me liberty or give me death"

1. Lincoln Second Inaugural

1. Washington Farewell Address opening

1. Reagan Challenger Address

### Shakespeare

1. Hamlet "To be or not to be" soliloquy

1. Romeo and Juliet balcony scene ("But soft, what light")

1. Macbeth witches ("Double double toil and trouble")

1. Merchant of Venice "Quality of mercy"

1. Julius Caesar "Friends, Romans, countrymen"

1. Henry V "St Crispin's Day" speech

1. As You Like It "All the world's a stage"

1. Sonnet 18 "Shall I compare thee"

1. Sonnet 116 "Let me not to the marriage"

1. Midsummer Night's Dream Puck's closing
...
1. Ecclesiastes 3:1-8 ("To everything there is a season")

1. 1 Corinthians 13 ("Love is patient")

1. Beatitudes (Matthew 5)

1. Isaiah 40 ("Comfort ye")

1. Book of Ruth 1:16-17
...
1. Bill of Rights - Second Amendment

1. Federalist 10 opening

1. Emancipation Proclamation opening

1. Pledge of Allegiance (pre and post 1954)
...
1. Frost "Stopping by Woods on a Snowy Evening"

1. Dickinson "Because I could not stop for Death"

1. Dickinson "Hope is the thing with feathers"

1. Poe "The Raven" first 5 stanzas

1. Whitman "O Captain! My Captain!"

1. Whitman "Song of Myself" opening

1. Blake "Tyger Tyger"

1. Wordsworth "I Wandered Lonely as a Cloud"

1. Shelley "Ozymandias"

1. Keats "Ode on a Grecian Urn" opening

1. Tennyson "Charge of the Light Brigade"

1. Longfellow "Paul Revere's Ride" opening
...
1. Paradise Lost opening

1. Divine Comedy opening
