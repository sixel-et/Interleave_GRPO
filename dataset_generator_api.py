"""
dataset_generator_api.py

Generates evaluation datasets for API-based frontier model evaluation.
Uses a prompt template that includes public domain context to avoid
copyright refusals from safety-tuned models.

Usage:
    # Generate curriculum for API evaluation
    python dataset_generator_api.py --curriculum --output-dir api_datasets/

    # Generate single difficulty level
    python dataset_generator_api.py --num-words 100 --save api_datasets/100words.jsonl

    # Preview without saving
    python dataset_generator_api.py --num-words 25 --preview 3
"""
...
# Curriculum stages
CURRICULUM_STAGES = [10, 25, 50, 100, 200, 500, 750, 1000, 1500]
...
The following fragments are from public domain texts (published before 1928).
...
def generate_curriculum(
    ...
    print("="*60)
    print("Done! Use with:")
    print(f"  python evaluate_api.py --backend anthropic --dataset {output_dir}/10words_test.jsonl --samples 100")
    print()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", default="api_datasets", help="Output directory for curriculum")
